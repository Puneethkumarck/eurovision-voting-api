...
public class LoadDataBase implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Germany").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Germany").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Germany").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Germany").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Germany").votingYear("2022").build());
        ...
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Germany").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Germany").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Romania").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Russia").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Romania").votingYear("2022").build());
        voteRepository.save(Vote.builder().countryFrom("France").votedFor("Romania").votingYear("2022").build());
